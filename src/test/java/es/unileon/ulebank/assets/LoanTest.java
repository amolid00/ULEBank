...
public class LoanTest {
    ...
    public void setUp() throws MalformedHandlerException, TransactionException,
        ...
        this.commercialAccountWithoutMoney = new Account(this.office,
                this.bank, "0000000002", authorized2);
        ...
        this.loanAmortize = new Loan(new FinancialProductHandler("LN", "ES"),
                ...
                this.commercialAccount2, this.authorized1, description2);
    ...
    public void testLoanNotAllowed() throws LoanException,
        ...
        this.loanNotAllowed = new Loan(new FinancialProductHandler("LN", "ES"),
                100000000, 0.01, PaymentPeriod.MONTHLY, 30,
                this.commercialAccount1, this.authorized1, description1);
    }
    ...
    public void testLoanWrongInterest() throws LoanException,
            LINCMalformedException, MalformedHandlerException {
        this.loanWrongInterest = new Loan(new FinancialProductHandler("LN",
                "ES"), 50000, 20, PaymentPeriod.MONTHLY, 23,
                this.commercialAccount1, this.authorized2, description2);
    }
    ...
    public void testLoanPaids() throws LoanException, ParseException {
        ...
        assertEquals(
                form.format(this.genericLoan.getNextPayment().getExpiration()),
                "01/01/2014");
        ...
        assertEquals(this.genericLoan.getNextPayment().getAmortization(),
                7954.45, .1);
        this.genericLoan.paid();
    ...
    public void forwadDates() throws ParseException {
        ...
        assertEquals(
                form.format(
                        this.genericLoan.forwardDate(date1,
