...
public class DoubleFeatureExtractorDirectDebitsNumberTest {
    ...
    InvalidCondition, TransactionException {
        ...
        this.extractor = new DoubleFeatureExtractorDirectDebitsNumber();
    ...
    public void testGetFeatureName() {
        Assert.assertEquals(this.extractor.getFeatureName(),
                "Numero medio de pagos domiciliados");
    }
    ...
    public void testGetFeature() {
        Assert.assertEquals(this.extractor.getFeature(), 4, Math.pow(10, -5));
    }
