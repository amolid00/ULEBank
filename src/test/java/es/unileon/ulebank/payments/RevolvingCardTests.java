...
public class RevolvingCardTests {

	RevolvingCard testCard;
	RevolvingCard testCard2;
	Handler handler;
	...
	public void setUp() throws Exception {
		...
		testCard = new RevolvingCard(handler, client, account, 400.0, 1000.0, 400.0, 1000.0, commissionEmission, commissionMaintenance, commissionRenovate);
	}
	...
	public void testGetCardType() {
		assertEquals(CardType.REVOLVING.toString(), testCard.getCardType().toString());
	}
	...
	public void testMakeTransaction() throws PaymentException {
		testCard.makeTransaction(0, "Concept");
	}
