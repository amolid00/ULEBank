...
public class PurseCardTests {
	...
	public void setUp() throws Exception {
		...
		testCard = new PurseCard(handler, client, account, 400.0, 1000.0, 400.0, 1000.0, commissionEmission, commissionMaintenance, commissionRenovate);
	}
	...
	public void testGetCardType() {
		assertEquals(CardType.PURSE.toString(), testCard.getCardType().toString());
	}
