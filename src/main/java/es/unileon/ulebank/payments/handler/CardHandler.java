 ...
 * @author Israel
 */
public class CardHandler implements Handler, Serializable {
    /**
     * 
     */
    ...
    public CardHandler(Handler bankId, String officeId, String cardId)
        ...
        final String cardNumber = bankId.toString() + officeId + cardId
                + controlDigit;
        String substring;
