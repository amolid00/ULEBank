...
/**
 * @author Israel Gestiona las operaciones que se realizan con la tarjeta
 */
public interface CardManager extends Serializable {
    ...
    /**
     * Method that changes the buy limits using the command with the limits from
     * buyLimits.jsp
     * 
     * @param diary
     * @param monthly
    ...
    public void changeBuyLimits(double diary, double monthly, Handler handler)
            throws IncorrectLimitException, AccountNotFoundException,
            PaymentException, TransactionException, CardNotFoundException,
            Exception;

    /**
     * Method that changes the cash limits using the command with the limits
     * from cashLimits.jsp
     * 
     * @param diary
     * @param monthly
