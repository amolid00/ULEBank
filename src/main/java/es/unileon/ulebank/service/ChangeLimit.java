 ...
 * @author Rober dCR
 * @date 14/05/2014
 * @brief Class which let us to set and get the limit values to cashLimits.jsp
 *        and buyLimits.jsp
 */
public class ChangeLimit {
    ...
    public void setDiaryLimit(int i) {
        this.diaryLimit = i;
        ChangeLimit.logger.info("Diary Limit set to " + i);
    }
    ...
    public void setMonthlyLimit(int i) {
        this.monthlyLimit = i;
        ChangeLimit.logger.info("Monthly Limit set to " + i);
    }
